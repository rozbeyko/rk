    ...
    roles: [
      {
        ...
        bullets: [
          ...
          "Specified, product-owned and built **Axora** — the internal delivery platform now in production: projects across 13 commercial shapes, contracts and orders, allocation, hours, cost, invoicing, health, CSAT and a rule-driven attention queue.",
...
export const OPERATING_NOW = [
  ...
  { status: "LIVE",     label: "Axora — delivery platform in production, gross margin +18%" },
...
export const NOW_TIMELINE = [
  ...
  { quarter: "Q2 2026", status: "completed", label: "Axora v1 — internal platform shipped" },
...
export const CASES = [
  {
    ...
    title: "Axora — delivery excellence, made measurable",
    period: "2026 — present",
    status: "LIVE",
    statusLabel: "Live and in daily use. Still shipping.",
    role: "Head of Delivery — operating model owner, product owner, and builder",
    summary: "Built and shipped the delivery operating model — and the internal platform under it — that connects pricing, contracts, staffing, hours and invoicing into one number: project margin. Gross margin up 18%, evened out across the portfolio, with cash-flow visibility a year ahead.",
    lede: "Axora is the operating layer of Triangu's delivery business — pricing logic, contract structure, capacity, hours, cost and invoicing joined up so that margin stops being an end-of-quarter surprise. It's live, it's used daily, and it moved gross margin +18% while making the next twelve months of cash flow something we can actually plan against.",
    kpis: [
      { n: "+18%", l: "gross margin" },
    ...
    tags: ["Delivery excellence", "Margin", "Portfolio management", "Forecasting", "Internal product", "Governance"],
    body: [
      { h: "The brief" },
      ...
      { h: "What Axora is" },
      { p: "Axora started as an operating model and became a **single-tenant internal platform** for the delivery business. Practice first — tooling added only where spreadsheets, memory, and disconnected systems stopped scaling." },
