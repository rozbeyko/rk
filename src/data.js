    ...
    roles: [
      {
        ...
        bullets: [
          ...
          "Established **delivery excellence and delivery health** as measured practices — six-segment health scoring, CSAT tracked separately from internal RAG, weekly reviews, and exception-based escalation.",
          "Brought **per-project margin transparency** — revenue and cost reported on planned / invoiced / landed bases, multi-currency, with cost attributed to projects rather than reconstructed at quarter end.",
          "**Levelled and lifted margin: gross margin +18%**, with the spread between best- and worst-performing engagements narrowed — the portfolio became predictable, not just more profitable on average.",
          "**Stabilised delivery on long-term contracts** with defined pricing and month-by-month value, giving a cash-flow view **at least 12 months forward** — planning is now an exercise, not a monthly scramble.",
          "Specified, product-owned and built **Axora** — an in-house **PSA (professional services automation)** platform, now in production: projects across 13 commercial shapes, contracts and orders, allocation, hours, cost, invoicing, health, CSAT and a rule-driven attention queue.",
...
export const OPERATING_NOW = [
  ...
  { status: "LIVE",     label: "Axora — in-house PSA platform in production, gross margin +18%" },
  { status: "LIVE",     label: "Maintra — 1,000+ users on the AI service book" },
...
export const NOW_TIMELINE = [
  ...
  { quarter: "Q2 2026", status: "completed", label: "Axora v1 — in-house PSA platform shipped" },
  { quarter: "Q2 2026", status: "live",      label: "Executive alignment cadence" },
  { quarter: "Q2 2026", status: "live",      label: "Capacity visibility" },
  { quarter: "Q3 2026", status: "completed", label: "Per-project margin transparency (3 bases)" },
  { quarter: "Q3 2026", status: "completed", label: "Long-term contracts + 12-month cash-flow view" },
  { quarter: "Q3 2026", status: "live",      label: "Gross margin +18%, evened across the portfolio" },
  { quarter: "Q3 2026", status: "live",      label: "Delivery health scoring + CSAT" },
  { quarter: "Q4 2026", status: "next",      label: "Delivery coaching beta" },
];
...
export const CASES = [
  {
    ...
    title: "Axora — a PSA built in-house, and the margin it moved",
    period: "2026 — present",
    status: "LIVE",
    statusLabel: "Live and in daily use. Still shipping.",
    role: "Head of Delivery — operating model owner, product owner, and builder",
    summary: "Built the delivery operating model and the in-house PSA platform under it — pricing, contracts, staffing, hours and invoicing joined into one number: project margin. Gross margin up 18%, evened out across the portfolio, with cash-flow visibility a year ahead.",
    lede: "Axora is Triangu's professional services automation platform, specified and built in-house — pricing logic, contract structure, capacity, hours, cost and invoicing joined up so that margin stops being an end-of-quarter surprise. It's live, it's used daily, and it moved gross margin +18% while making the next twelve months of cash flow something we can actually plan against.",
    kpis: [
      { n: "+18%", l: "gross margin" },
      { n: "LIVE", l: "in daily use" },
      { n: "40+",  l: "engagements tracked" },
      { n: "12 mo", l: "cash-flow horizon" },
      { n: "13",   l: "engagement shapes" },
      { n: "3",    l: "margin bases" },
    ],
    tags: ["PSA", "Delivery excellence", "Margin", "Resource management", "Forecasting", "Governance"],
    body: [
      { h: "The brief" },
      { p: "Triangu was scaling without a dedicated delivery practice. I joined as the first delivery hire — initially as Delivery Manager, later stepping into Head of Delivery." },
      { p: "The brief was simple to say and hard to do: replace average-rate guessing with pricing logic, replace \"ask around\" with visible operating standards, replace founder-in-the-weeds execution with leadership cadence, portfolio visibility, and repeatable delivery patterns." },
      { p: "The honest starting position: margin per project was a **quarter-end reconstruction**, not a live number. Different engagements were priced on different instincts. Cash flow was knowable one month out, roughly." },
      { h: "What Axora is" },
      { p: "Axora started as an operating model and became software. The category has a name: it's a **PSA — professional services automation** — the class of system that joins projects, contracts, people, hours, cost and invoicing into one place so a services business can see its own margin. Kantata, Certinia and Scoro sell one. We built ours, single-tenant and in-house, because the commercial shapes we actually trade in didn't survive contact with any of them." },
      { p: "Not a SaaS: nobody subscribes to it, there is no second tenant, and it isn't a product I'm selling. Practice first — software added only where spreadsheets, memory and disconnected systems stopped scaling. Its core is **resource management**: who is billable, what they cost, where they're allocated. It is not an HR system, and doesn't pretend to be — no payroll, no leave, no recruiting." },
      { p: "The design principle that makes it work: **the commercial shape of an engagement is a first-class citizen, not a label**. A T&M project earns hours × rate. A fixed-price project earns a contracted value. A retainer is a monthly envelope. A rolling contract is a ladder of sub-contracts. A milestone project earns on completion. Thirteen shapes in total, each with its own fields, its own revenue formula and its own reporting lens — they never collapse into one average." },
      { p: "The second principle: **rule-driven, not editorial**. Every alert, every nudge, every dashboard card comes from deterministic rules over the same data — 24+ of them. No AI-generated prose sits between a leader and a number that has money attached to it." },
      { h: "What's inside" },
      { mods: true },
      { h: "What changed for the business" },
      { p: "**Margin transparency, per project, live.** Revenue and cost are reported on three layered bases — *planned* (what we said we'd bill and what we said it'd cost), *invoiced* (what we've billed and what it accrued), and *landed* (what we've actually collected and actually paid people). Same project, three honest views, one click apart. Multi-currency throughout, with the FX rate stored on every invoice rather than re-derived later." },
      { p: "**Margin levelled and lifted — gross margin up 18%.** Once the leaks were visible per engagement — under-priced roles, unbilled hours, cost profiles nobody had filled in, discounts nobody had governed — most of them turned out to be fixable one conversation at a time. The point isn't only that the average went up; it's that the **spread between the best and worst engagements narrowed**, which is what makes a portfolio predictable." },
      { p: "**Delivery stabilised on long-term contracts.** Engagements were restructured onto longer commitments with defined pricing and month-by-month value, so revenue stopped being re-negotiated every few weeks. The result is a cash-flow curve we can read **at least twelve months ahead** — which turns planning from a monthly scramble into an actual exercise." },
      { p: "**Delivery health became a metric, not a mood.** Six-segment health scores, CSAT tracked separately from internal RAG, weekly reviews, blockers and key decisions all logged against the engagement. When health goes red while the delivery status still says on-track, the system says so out loud — that mismatch is its own alert." },
      { p: "**Exception-based leadership.** The Attention Queue and Weekly Brief surface only what has tripped a rule: overdue invoices, over-allocated people, projects with no PM, T&M work with no selling rate, hours pacing behind plan, contracts approaching renewal. Leadership reads the exceptions; delivery keeps the room." },
      { h: "Why I'd treat it as a case study" },
      { p: "Most \"Head of Delivery\" roles inherit a machine. This one started closer to a blank page — pricing logic, intake, executive cadence, portfolio tiering, financial controls, reusable delivery artifacts, and eventually Axora itself, which I specified, product-owned and built." },
      { p: "It's also the clearest evidence I have for something I believe about this job: **delivery excellence is a financial discipline**. Cadence and health scores matter because they show up in margin and cash flow. If a delivery practice can't point at those two numbers and explain what it did to them, it's ceremony." },
    ],
    modules: [
      { name: "Dashboard & Attention Queue", desc: "Portfolio hero with margin by basis, utilisation, cash. 24+ rule-driven alerts with P1/P2/P3 triage, margin-leak bars per project, capacity heatmap, renewals timeline, engagement mix." },
      { name: "Projects", desc: "Every engagement under its commercial shape — 13 types, each with its own revenue formula and reporting card. Delivery status, phase ribbon, notes, risks, key decisions, weekly reviews." },
      { name: "Accounts, contracts & orders", desc: "The legal layer: MSAs with billing cadence, sub-orders (SOWs, change orders), milestones, rolling sub-contracts, stakeholders, pipeline and contract outlook." },
      { name: "People", desc: "Who's billable and who's investment overhead, reporting lines, practices, skills, CVs, and workforce cost profiles — the input that makes project cost real." },
      { name: "Allocation", desc: "Who's planned on what, by period, hard vs soft bookings. Over/under-allocation detection, capacity forecasting, and soft-booked pipeline that doesn't pollute committed numbers." },
      { name: "Plan vs Fact", desc: "Planned hours and cost against what actually happened, month by month, with a working-day-prorated pacing alarm that fires mid-month rather than after the invoice." },
      { name: "Financials", desc: "Revenue, cost and margin on three bases (planned / invoiced / landed), multi-currency with per-invoice FX, cost allocated to projects by allocation share, and a separate investment lane for non-billable work." },
      { name: "Invoicing", desc: "Per-invoice rows and drawer, approval flow, PDF attach and preview, anomaly banner, overdue and disputed tracking, plus workforce payables on the cost side." },
      { name: "CSAT & delivery health", desc: "Client-perceived satisfaction collected through signed public links, tracked separately from internal RAG; six-segment health scores with trend charts and an at-risk band." },
      { name: "Notifications & audit", desc: "14+ notification kinds in-app and to Slack (DM the responsible person, post to the shared channel), per-project subscriptions, plus a full activity log and audit trail with per-field history and restore-from-snapshot." },
    ],
    capabilities: [
      { state: "done",    label: "Rate cards (role/seniority based)" },
      { state: "done",    label: "Delivery HQ (Confluence space)" },
      { state: "done",    label: "Portfolio registry + tiering" },
      { state: "done",    label: "Executive alignment cadence" },
      { state: "done",    label: "Sales → delivery intake" },
      { state: "done",    label: "Plan vs Fact / margin visibility" },
      { state: "done",    label: "Axora platform in production" },
      { state: "done",    label: "Invoicing + cost payables" },
      { state: "done",    label: "Delivery health scoring + CSAT" },
      { state: "done",    label: "Notifications (in-app + Slack)" },
      { state: "partial", label: "Capacity forecasting" },
      { state: "partial", label: "Per-person hours via Jira / Tempo" },
      { state: "todo",    label: "Salary-first cost model" },
  ...
  },
  {
    ...
    period: "2021 — 2022",
    status: "ARCHIVED",
    role: "Project Coordinator / Delivery Manager, R&D Tools",
  ...
  },
  {
    ...
    period: "2026 — present",
    status: "LIVE",
    role: "Solo founder — concept, design, build, launch",
    summary: "First fully personal product launch — an AI-powered service book for car owners. Born from a real, boring problem, and now past 1,000 users: people I've never met keep their cars' history in something I built in the evenings.",
    kpis: [
      { n: "1,000+", l: "users" },
      { n: "1", l: "solo founder" },
...
export const NOW = {
  updated: "August 2026",
  bullets: [
    { k: "Working on", v: "Delivery at Triangu — a 40+ project portfolio, Axora live in production, gross margin up 18% and a cash-flow view twelve months out." },
    { k: "Side project", v: "Maintra — past 1,000 users. Now working on multi-vehicle plans, recurring service templates, and an export-to-PDF service book." },
    { k: "Side hustle", v: "New car account on Instagram (@rokjero) in English — started 10 June 2026, past 2M views and 4,500 followers in its first eleven weeks." },
...
export const CREATOR = {
  handle: "@rokjero",
  platform: "Instagram",
  launched: "10 June 2026",
  bio: "A car account in English — the ownership side (what breaks, what it costs, what's actually worth doing) and the looking-at-them side (cars shot properly). Launched 10 June 2026 and past 2 million views in its first eleven weeks.",
  windowLabel: "Instagram · @rokjero · last 90 days (26 May — 23 Aug 2026)",
  headlineStats: [
    { n: "2.07M", u: "",  l: "Views in 90 days" },
    { n: "1.03M", u: "",  l: "Unique viewers" },
    { n: "4,072", u: "+", l: "Net new followers" },
    { n: "209K",  u: "",  l: "Interactions" },
  ],
  contentMix: [
    { name: "Posts",   views: "1.6M", growth: "~77% of all views", note: "The surprise — static and carousel posts, not Reels, carried this account.", color: "#c084fc" },
    { name: "Reels",   views: "407K", growth: "~20% of all views", note: "Still the discovery engine, just not the main one here.", color: "#f0abfc" },
    { name: "Stories", views: "24K",  growth: "~1% of all views",  note: "Followers-only by definition. Retention, not reach.", color: "#818cf8" },
  ],
  detailStats: [
    { n: "96.7%",  l: "Non-follower reach" },
    { n: "3.3%",   l: "Reach from followers" },
    { n: "1.03M",  l: "Unique viewers" },
    { n: "209K",   l: "Total interactions" },
    { n: "~77%",   l: "Views from posts, not Reels" },
    { n: "~10",    l: "Interactions per 100 views" },
    { n: "4,500",  l: "Followers today" },
    { n: "11 wks", l: "Account age" },
  ],
  takeaways: [
    "96.7% of reach came from people who don't follow the account. Followers are the receipt, not the engine.",
    "Posts beat Reels four to one here — the exact inverse of my gaming account, where 99.9% of views came from Reels. Format advice that isn't tied to a niche is worthless.",
    "One post in late August did roughly 800K views in a day — around 40% of the whole quarter. The rest of the curve is almost flat. Distribution is lumpy, so judging a week by its numbers tells you nothing.",
    "Two and a half months from zero to 2M views is a cadence result, not a talent one. Nobody was paying me to publish, which is exactly what makes it a useful test of whether I actually believe what I tell delivery teams.",
  ],
  legacy: {
    handleOld: "@ki_rich",
    stats: [
      { n: "106.4K", l: "followers on the account I walked away from" },
      { n: "2.8M",   l: "likes on it" },
      { n: "4.3M",   l: "views / 90 days on the gaming account" },
      { n: "2",      l: "restarts from zero" },
    ],
  },
};
