...
export const CASES = [
  {
    ...
    period: "2026 — present",
    status: "BUILDING",
    statusLabel: "Used in parts. Still evolving.",
    role: "Head of Delivery",
    summary: "Building an internal delivery operating model connecting pricing, portfolio governance, staffing visibility, executive cadence, and delivery execution across a 40+ engagement practice.",
    lede: "Building Triangu's delivery operating model from first principles — pricing logic, executive cadence, portfolio visibility, capacity planning, reusable delivery artifacts, and an internal delivery cockpit designed to answer what we're delivering, where margins leak, who's allocated where, and how healthy the portfolio actually is.",
    kpis: [
      { n: "40+",  l: "engagements in portfolio" },
      { n: "50+",  l: "people in delivery scope" },
      { n: "20+",  l: "initiatives mapped" },
      { n: "LIVE", l: "parts already in use" },
    ],
    tags: ["Delivery", "Governance", "Portfolio management", "Jira", "Confluence", "Excel", "Tempo", "Internal tooling"],
    body: [
      { h: "The brief" },
      ...
      { p: "The brief was simple: replace average-rate guessing with pricing logic, replace \"ask around\" with visible operating standards, replace founder-in-the-weeds execution with leadership cadences, portfolio visibility, and repeatable delivery patterns." },
      { h: "What it is" },
      { p: "Axora is not a product." },
      { p: "It's an internal operating model for delivery — practice-first, with tooling added only where spreadsheets, memory, and disconnected systems stop scaling." },
      { p: "Some parts already run in live work. Some still exist as buildout." },
      { p: "This page tracks both." },
      { h: "Why I'd treat it as a case study" },
      { p: "Most \"Head of Delivery\" roles inherit a machine." },
      { p: "This one started closer to a blank page — pricing logic, Jira intake, executive cadence, portfolio tiering, financial controls, reusable delivery artifacts, and eventually Axora." },
      { p: "Some parts are already live and used in day-to-day delivery. Others are still being shaped." },
      { p: "I'm documenting it as a case study because building a delivery practice deserves the same rigor as client delivery — clear ownership, measurable standards, working cadences, and visible trade-offs." },
    ],
    capabilities: [
      { state: "done",    label: "Rate cards (role/seniority based)" },
      { state: "done",    label: "Delivery HQ (Confluence space)" },
      { state: "done",    label: "Initiative registry" },
      ...
      { state: "partial", label: "Axora delivery cockpit" },
